...
export const preToCodeBlock = (preProps: PrePropsType) => {
    const children = preProps.children as ReactElement<any, string | JSXElementConstructor<any>> | undefined
    ...
    if (children && children.props) {
        ...
        return {
            ...
            language:
                matches && matches.groups && matches.groups.lang ? (matches.groups.lang as Language) : ("" as Language),
            ...props,
        }
    }
}
